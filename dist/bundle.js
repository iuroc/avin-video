...
console.log(ponconjs_1["default"]);
console.log(Pjax);

},{"pjax":2,"ponconjs":26}],2:[function(require,module,exports){
...
},{"./lib/abort-request":3,"./lib/events/on":5,"./lib/events/trigger":6,"./lib/execute-scripts":7,"./lib/foreach-els":8,"./lib/foreach-selectors":9,"./lib/is-supported":10,"./lib/parse-options":11,"./lib/proto/attach-form":12,"./lib/proto/attach-link":13,"./lib/proto/handle-response":14,"./lib/proto/log":15,"./lib/proto/parse-element":16,"./lib/send-request":17,"./lib/switches":19,"./lib/switches-selectors":18,"./lib/uniqueid":20,"./lib/util/clone":21,"./lib/util/contains":22,"./lib/util/extend":23,"./lib/util/noop":24}],3:[function(require,module,exports){
...
},{"./util/noop":24}],4:[function(require,module,exports){
...
},{"./switches":19}],12:[function(require,module,exports){
...
},{"../events/on":5,"../util/clone":21}],13:[function(require,module,exports){
var on = require("../events/on");
var clone = require("../util/clone");
...
},{"../events/on":5,"../util/clone":21}],14:[function(require,module,exports){
var clone = require("../util/clone");
...
},{"../events/trigger":6,"../uniqueid":20,"../util/clone":21}],15:[function(require,module,exports){
module.exports = function() {
...
},{"./util/update-query-string":25}],18:[function(require,module,exports){
var forEachEls = require("./foreach-els");
...
},{"./foreach-els":8,"./switches":19}],19:[function(require,module,exports){
var on = require("./events/on");
...
},{"./events/on":5}],20:[function(require,module,exports){
module.exports = (function() {
  var counter = 0;
  return function() {
